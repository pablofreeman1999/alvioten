...
<head>
	...
	<link type="text/css" rel="stylesheet" href="style-1.css" tppabs="http://luna.speka-shop.xyz/files/_default/privacypolicy/RU/css/style.css" />
...
<body>
	...
	<div class="block_more_info">
		...
		<p> Треті сторони, включаючи компанії Google, показують оголошення нашої компанії на сторінках сайтів в Інтернеті. Треті сторони, включно з організацією Google, використовують cookie, щоб показувати оголошення, засновані на попередніх відвідуваннях користувачем наших веб-сайтів і інтересах в веб-браузерах. Користувачі можуть заборонити компаніям Google використовувати cookie. Для цього необхідно відвідати спеціальну сторінку компанії Google за цією адресою: http://www.google.com/privacy/ads/ </p>
